...
import type { FlowchartRfNode, NodeDefinition, SupabaseConfiguration } from "../types"
import { renameNodeAction } from "../nodeActions"

function SupabaseFlowNode({ data }: NodeProps) {
...
export const supabaseNode: NodeDefinition<SupabaseConfiguration> = {
  type: "node:supabase",
  defaultTitle: "Supabase",
  description: "Consulta o modifica datos en Supabase.",
  Icon: Database,
  ...
  FlowComponent: SupabaseFlowNode,

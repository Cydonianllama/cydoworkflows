...
import type { FlowchartRfNode, NodeDefinition, TelegramConfiguration } from "../types"
import { renameNodeAction } from "../nodeActions"

function TelegramFlowNode({ data }: NodeProps) {
...
export const telegramNode: NodeDefinition<TelegramConfiguration> = {
  type: "node:telegram",
  defaultTitle: "Telegram",
  description: "Envía un mensaje por Telegram.",
  Icon: Send,
  category: "integraciones",
  defaultConfiguration: { botToken: "", chatId: "", text: "" },
  FlowComponent: TelegramFlowNode,

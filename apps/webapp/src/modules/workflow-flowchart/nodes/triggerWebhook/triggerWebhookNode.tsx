...
import type { FlowchartRfNode, NodeDefinition, TriggerWebhookConfiguration } from "../types"
import { renameNodeAction } from "../nodeActions"

function TriggerWebhookFlowNode({ data }: NodeProps) {
...
export const triggerWebhookNode: NodeDefinition<TriggerWebhookConfiguration> = {
  type: "node:triggerwebhook",
  defaultTitle: "Webhook",
  description: "Se activa al recibir un webhook.",
  Icon: Webhook,
  category: "triggers",
  defaultConfiguration: {},
  FlowComponent: TriggerWebhookFlowNode,

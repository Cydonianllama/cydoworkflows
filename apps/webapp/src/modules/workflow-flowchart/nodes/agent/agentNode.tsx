...
import type { AgentConfiguration, FlowchartRfNode, NodeDefinition } from "../types"
...
export const agentNode: NodeDefinition<AgentConfiguration> = {
  type: "node:agent",
  defaultTitle: "Agente",
  description: "Ejecuta una acción con un prompt.",
  Icon: Bot,
  category: "ia",
  defaultConfiguration: { prompt: "" },
  FlowComponent: AgentFlowNode,

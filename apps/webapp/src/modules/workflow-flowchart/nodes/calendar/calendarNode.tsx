...
import type { CalendarConfiguration, FlowchartRfNode, NodeDefinition } from "../types"
import { renameNodeAction } from "../nodeActions"

function CalendarFlowNode({ data }: NodeProps) {
...
export const calendarNode: NodeDefinition<CalendarConfiguration> = {
  type: "node:calendar",
  defaultTitle: "Google Calendar",
  description: "Crea o actualiza un evento de calendario.",
  Icon: CalendarDays,
  ...
  FlowComponent: CalendarFlowNode,

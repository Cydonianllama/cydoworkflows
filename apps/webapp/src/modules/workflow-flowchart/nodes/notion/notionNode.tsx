...
import type { FlowchartRfNode, NodeDefinition, NotionConfiguration } from "../types"
import { renameNodeAction } from "../nodeActions"

function NotionFlowNode({ data }: NodeProps) {
...
export const notionNode: NodeDefinition<NotionConfiguration> = {
  type: "node:notion",
  defaultTitle: "Notion",
  description: "Crea o actualiza una página en Notion.",
  Icon: FileText,

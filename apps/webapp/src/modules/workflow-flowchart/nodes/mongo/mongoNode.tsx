...
import type { FlowchartRfNode, MongoConfiguration, NodeDefinition } from "../types"
import { renameNodeAction } from "../nodeActions"

function MongoFlowNode({ data }: NodeProps) {
...
export const mongoNode: NodeDefinition<MongoConfiguration> = {
  type: "node:mongo",
  defaultTitle: "MongoDB",
  description: "Opera documentos en MongoDB.",
  Icon: Leaf,
  category: "integraciones",
  defaultConfiguration: { uri: "", collection: "", operation: "find", filter: "" },
  FlowComponent: MongoFlowNode,

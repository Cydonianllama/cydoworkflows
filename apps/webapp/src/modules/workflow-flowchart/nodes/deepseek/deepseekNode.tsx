...
import type { DeepSeekConfiguration, FlowchartRfNode, NodeDefinition } from "../types"
import { renameNodeAction } from "../nodeActions"

function DeepSeekFlowNode({ data }: NodeProps) {
...
export const deepseekNode: NodeDefinition<DeepSeekConfiguration> = {
  type: "node:deepseek",
  defaultTitle: "DeepSeek",
  description: "Ejecuta una llamada a DeepSeek.",
  Icon: Brain,
  category: "ia",
  defaultConfiguration: {},
  FlowComponent: DeepSeekFlowNode,

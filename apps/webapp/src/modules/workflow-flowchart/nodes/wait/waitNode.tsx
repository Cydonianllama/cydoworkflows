...
import type { FlowchartRfNode, NodeDefinition, WaitConfiguration } from "../types"
import { renameNodeAction } from "../nodeActions"

function WaitFlowNode({ data }: NodeProps) {
...
export const waitNode: NodeDefinition<WaitConfiguration> = {
  type: "node:wait",
  defaultTitle: "Wait",

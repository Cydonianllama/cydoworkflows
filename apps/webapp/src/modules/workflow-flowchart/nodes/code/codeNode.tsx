...
import type { CodeConfiguration, FlowchartRfNode, NodeDefinition } from "../types"
import { renameNodeAction } from "../nodeActions"

function CodeFlowNode({ data }: NodeProps) {
...
export const codeNode: NodeDefinition<CodeConfiguration> = {
  type: "node:code",
  defaultTitle: "Code",
  description: "Ejecuta un fragmento de código personalizado.",
  Icon: Code2,
  category: "logica",

...
import type { FlowchartRfNode, GmailConfiguration, NodeDefinition } from "../types"
import { renameNodeAction } from "../nodeActions"

function GmailFlowNode({ data }: NodeProps) {
...
export const gmailNode: NodeDefinition<GmailConfiguration> = {
  type: "node:gmail",
  defaultTitle: "Gmail",
  description: "Envía un correo electrónico con Gmail.",
  Icon: Mail,

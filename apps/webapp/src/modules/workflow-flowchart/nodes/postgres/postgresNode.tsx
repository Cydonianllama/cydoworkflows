...
import type { FlowchartRfNode, NodeDefinition, PostgresConfiguration } from "../types"
import { renameNodeAction } from "../nodeActions"

function PostgresFlowNode({ data }: NodeProps) {
...
export const postgresNode: NodeDefinition<PostgresConfiguration> = {
  type: "node:postgres",
  defaultTitle: "Postgres",
  description: "Ejecuta una consulta en PostgreSQL.",
  Icon: Database,
  category: "integraciones",
  defaultConfiguration: { connectionString: "", query: "" },
  FlowComponent: PostgresFlowNode,

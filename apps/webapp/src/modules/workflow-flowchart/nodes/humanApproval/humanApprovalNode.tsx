...
import type { FlowchartRfNode, HumanApprovalConfiguration, NodeDefinition } from "../types"
import { renameNodeAction } from "../nodeActions"

function HumanApprovalFlowNode({ data }: NodeProps) {
...
export const humanApprovalNode: NodeDefinition<HumanApprovalConfiguration> = {
  type: "node:humanapproval",
  defaultTitle: "Human Approval",
  description: "Detiene el flujo hasta que una persona lo apruebe.",
  Icon: UserCheck,
  category: "logica",
  ...
  FlowComponent: HumanApprovalFlowNode,

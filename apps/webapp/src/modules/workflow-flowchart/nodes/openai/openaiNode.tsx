...
import type { FlowchartRfNode, NodeDefinition, OpenAIConfiguration } from "../types"
import { renameNodeAction } from "../nodeActions"

function OpenAIFlowNode({ data }: NodeProps) {
...
export const openaiNode: NodeDefinition<OpenAIConfiguration> = {
  type: "node:openai",
  defaultTitle: "OpenAI",
  description: "Ejecuta una llamada a OpenAI.",
  Icon: Sparkles,
  category: "ia",
  defaultConfiguration: {},
  FlowComponent: OpenAIFlowNode,

...
import type { CydoflowConfiguration, FlowchartRfNode, NodeDefinition } from "../types"
import { renameNodeAction } from "../nodeActions"

function CydoflowFlowNode({ data }: NodeProps) {
...
export const cydoflowNode: NodeDefinition<CydoflowConfiguration> = {
  type: "node:cydoflow",
  defaultTitle: "CydoFlow",
  description: "Ejecuta otro flujo de CydoFlow.",
  Icon: Workflow,
  category: "logica",
  defaultConfiguration: {},
  FlowComponent: CydoflowFlowNode,
